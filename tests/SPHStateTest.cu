...
int main()
{
    ...
    try
    {
        SPHDEM uninterrupted{executionMode::Hybrid};
        SPHDEM withOutput{executionMode::Hybrid};
        SPHDEM split{executionMode::Hybrid};
        SPHDEM CPUReference{executionMode::CPU};
        configure(uninterrupted);
        configure(withOutput);
        configure(split);
        configure(CPUReference);
        ...
        requireEqual(uninterrupted, CPUReference, "CPU and Hybrid SPH execution produced different numerical states.");
        ...
        SPHDEM changedConfiguration{executionMode::Hybrid};
        ...
        SPHDEM restartedFromCurrentState{executionMode::Hybrid};
        ...
        SPHDEM stationary{executionMode::Hybrid};
        ...
        try
        {
            SPHDEM unsafeTimeStep{executionMode::Hybrid};
